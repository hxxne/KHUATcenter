...
svg_golf = '<i class="fa-solid fa-golf-ball-tee"></i>'

jeondam = [
    ('강석', '축구', svg_football),
    ('권남준', '배드민턴', '<svg class="custom-icon" viewBox="0 0 48 48" style="transform: rotate(45deg);"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="2" stroke-width="4"><path d="M19.5 44c2.49 0 4.5-2.01 4.5-4.5V19h-4l-5 20.5c0 2.49 2.01 4.5 4.5 4.5"/><path d="M20 19h-4L6.68 37.9c-1.11 2.61.48 5.74 3.3 6.07A4.494 4.494 0 0 0 15 39.5M28.5 44c-2.49 0-4.5-2.01-4.5-4.5V19h4l5 20.5c0 2.49-2.01 4.5-4.5 4.5"/><path d="M28 19h4l9.32 18.9c1.11 2.61-.48 5.74-3.3 6.07A4.494 4.494 0 0 1 33 39.5"/><path fill="currentColor" d="M16.06 13c-.04-.33-.06-.66-.06-1c0-4.42 3.58-8 8-8s8 3.58 8 8c0 .34-.02.67-.06 1z"/></g></svg>'),
    ('기윤서', '핸드볼', '<svg class="custom-icon" viewBox="0 0 24 24"><path fill="currentColor" d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,4A8,8 0 0,1 19.96,11.5L16.41,9.81L16.03,6L12,4M10,6.09L9.6,9.85L6.05,11.54C6.38,8.27 8.93,5.65 12,5.1V6C11.23,6 10.53,6.34 10,6.09M3.93,12L7.33,13.62L7.75,17.43C5.55,16.5 4,14.4 3.93,12M8.19,17.8L11,19.26V20C9.64,20 8.35,19.5 7.37,18.66L8.19,17.8M13,20V19.26L15.82,17.8L16.63,18.66C15.65,19.5 14.36,20 13,20M16.25,17.43L16.67,13.62L20.07,12C20,14.4 18.45,16.5 16.25,17.43M12,11L14,12V14L12,15L10,14V12L12,11Z" /></svg>'),
    ('문채연', '시범단', '<svg class="custom-icon" viewBox="0 0 24 24" style="transform: scaleX(-1);"><path fill="currentColor" d="m19.8 2l-8.2 6.7l-1.21-1.04L14 5.58L9.41 1L8 2.41l2.74 2.74L5 8.46l-1.19 4.29L6.27 17L8 16l-2.03-3.5l.35-1.32L9.5 13 l3 3 l-2 2 h2 l2 -2 l-2 -4 L21 3.4zM5 3a2 2 0 1 1 0 4c-1.11 0-2-.89-2-2s.9-2 2-2"/></svg>'),
    ('박세민', '배구', svg_volleyball),
    ('유승아', '품새', '<svg class="custom-icon" viewBox="0 0 32 32"><path fill="currentColor" d="M7.08 6.459A2.93 2.93 0 0 1 9.614 5h12.77c1.035 0 2.013.54 2.538 1.462l5.81 10.051a2.03 2.03 0 0 1-.703 2.736l-.013.009l-3.728 2.142l-.003.002a2 2 0 0 1-1.786.11v4.829c0 .892-.713 1.659-1.655 1.659H9.165A1.664 1.664 0 0 1 7.5 26.34v-4.828a2 2 0 0 1-1.786-.11l-.002-.002l-3.706-2.135l-.004-.003a2.01 2.01 0 0 1-.732-2.744l.002-.003zM19.091 7L16 13.57L12.908 7h-1.934l4.059 8.625l-.235.5h1.934L21.026 7zm-1.255 9.125H22.5v-1.23l.866 1.492a.7.7 0 0 1 .081.14l1.822 3.135l.001.003l.003.002l.002.001l.003.002h.003l.003.001l.003-.002l3.698-2.125a.04.04 0 0 0 .015-.022v-.007l-.002-.008l-5.813-10.055a.91.91 0 0 0-.8-.452h-.254zm-4.042 0c.001-.143.033-.287.095-.42l.038-.08L9.868 7h-.253a.93.93 0 0 0-.804.459L3.001 17.52v.002q0 .005.003.007l.004.004l3.709 2.137h.003l.008-.004l.002-.003l.002-.002L9.5 14.863v1.262zM9.5 26h13v-8.125h-4.474l1.766 3.752a.875.875 0 1 1-1.584.746l-2.116-4.498h-.184l-2.116 4.498a.875.875 0 1 1-1.584-.746l1.766-3.752H9.5z"/></svg>'),
    ('유영민', '럭비', svg_rugby),
    ('유주승', '야구', svg_baseball),
    ('유지민', '겨루기', '<svg class="custom-icon" viewBox="0 0 24 24"><path fill="currentColor" d="m19.8 2l-8.2 6.7l-1.21-1.04L14 5.58L9.41 1L8 2.41l2.74 2.74L5 8.46l-1.19 4.29L6.27 17L8 16l-2.03-3.5l.35-1.32L9.5 13l.5 9h2l.5-10L21 3.4zM5 3a2 2 0 1 1 0 4c-1.11 0-2-.89-2-2s.9-2 2-2"/></svg>'),
    ('이상준', '농구', svg_basketball),
    ('이예인', '골프', svg_golf),
    ('한혜서', '겨루기', '<svg class="custom-icon" viewBox="0 0 24 24"><path fill="currentColor" d="m19.8 2l-8.2 6.7l-1.21-1.04L14 5.58L9.41 1L8 2.41l2.74 2.74L5 8.46l-1.19 4.29L6.27 17L8 16l-2.03-3.5l.35-1.32L9.5 13l.5 9h2l.5-10L21 3.4zM5 3a2 2 0 1 1 0 4c-1.11 0-2-.89-2-2s.9-2 2-2"/></svg>')
]
...
bijeondam = ['권준홍', '천지훈', '안은지', '이천이']
bijeondam_cards = "".join([f'<div class="staff-card"><div class="staff-avatar-icon">{svg_1}</div><div class="staff-details"><div class="staff-name">{name}</div><div class="sport-badge">센터 AT</div></div></div>' for name in bijeondam])
...
# Note: Added Lee Jae-wook back normally without display:none
new_html = f"""<!-- 3rd Tier and Below Container -->
                <div class="org-level level-3-container" style="display: flex; width: 100%; justify-content: center; gap: 40px; align-items: flex-start; flex-wrap: nowrap; max-width: 1400px; margin: 0 auto;">
                    ...
                    <!-- Left Branch: 김준영 -->
                    <div class="org-branch" style="display: flex; flex-direction: column; align-items: center; width: 720px;">
                        ...
                        <!-- Horizontal split for two groups -->
                        <div class="org-line horizontal-line" style="width: 360px;"></div>
                        <div class="org-line vertical-branches" style="width: 360px; justify-content: space-between;">
                            <div class="org-line" style="width: 2px; height: 20px;"></div>
                            <div class="org-line" style="width: 2px; height: 20px;"></div>
                        </div>
                        
                        <div style="display: flex; width: 100%; justify-content: space-between; gap: 20px;">
                            <!-- 전담 AT -->
                            <div class="org-group" style="width: 350px;">
...
old_sr = '"스포츠재활": ["이진주", "송찬", "권준홍", "박서현"]'
new_sr = '"스포츠재활": ["이진주", "송찬", "박서현"],\n                "센터 AT": ["권준홍", "천지훈", "안은지", "이천이"]'
final_html = final_html.replace(old_sr, new_sr)

with open('index.html', 'w', encoding='utf-8') as f:
    f.write(final_html)
    print("New HTML written successfully.")
