...
rehabs = ['기윤서', '문수연', '문채연', '박서현', '송찬', '우지윤', '유승아', '유영민', '윤서연', '이예인', '이진주', '이채원', '조연지', '조현준', '진승희', '최민혁', '권준홍', '천지훈', '안은지', '이천이']
rehabs.sort()
...
# Also let's fix assistantData for "스포츠재활" to include all 4 people again
old_js = '"스포츠재활": ["이진주", "송찬", "박서현"]'
new_js = '"스포츠재활": ["이진주", "송찬", "권준홍", "박서현"]'
final_html = final_html.replace(old_js, new_js)

with open('index.html', 'w', encoding='utf-8') as f:
    f.write(final_html)
    print("Names restored to 스포츠재활강사.")
