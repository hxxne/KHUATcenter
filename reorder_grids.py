...
# Shibumdan icon is now CSS mask
...
# New ordered jeondam pairs according to user
jeondam = [
    ('강석', '축구', svg_football),
    ('기윤서', '핸드볼', svg_handball),
    ('이상준', '농구', svg_basketball),
    ('박세민', '배구', svg_volleyball),
    ('권남준', '배드민턴', svg_badminton), # User said 핸드볼 twice, replacing 2nd with 배드민턴
    ('유영민', '럭비', svg_rugby),
    ('유승아', '품새', svg_poomsae),
...
with open('index.html', 'w', encoding='utf-8') as f:
    f.write(final_html)
    print("Ordered pairs and 3-column rehab set.")
