...
bijeondam_html = """
                                <div class="simple-staff-list" style="background: white; border-radius: 12px; padding: 25px 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); text-align: center; border: 1px solid #f0f0f0;">
                                    <p style="margin: 0; font-size: 1.15rem; font-weight: 600; color: #333; line-height: 1.8;">
                                        권준홍, 천지훈, 안은지, 이천이
                                    </p>
                                </div>
"""
