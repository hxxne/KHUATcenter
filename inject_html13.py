...
tucked_leg_svg = '<svg class="custom-icon" viewBox="0 0 24 24" style="transform: scaleX(-1);"><path fill="currentColor" d="m19.8 2l-8.2 6.7l-1.21-1.04L14 5.58L9.41 1L8 2.41l2.74 2.74L5 8.46l-1.19 4.29L6.27 17L8 16l-2.03-3.5l.35-1.32L9.5 13 l3 3 l-2 2 h2 l2 -2 l-2 -4 L21 3.4zM5 3a2 2 0 1 1 0 4c-1.11 0-2-.89-2-2s.9-2 2-2"/></svg>'
content = update_icon(content, '문채연', '시범단', tucked_leg_svg)

with open(html_file, 'w', encoding='utf-8') as f:
    f.write(content)

print("Tucked leg side kick applied!")
