...
document.addEventListener('DOMContentLoaded', () => {
    ...
    "1": [
        {
            "authors": "Kim S, Lim J, Bang HS, Park J.",
            "title": "Bilateral femoral cartilage morphology in athletes with unilateral patellofemoral pain: associations with pain severity and self-reported function.",
            "journal": "Journal of Athletic Training. In press; 2026."
        },
        {
            "authors": "Kim J, Kang E, Park J.",
            "title": "Medial meniscus extrusion after 30-min running in individuals who underwent meniscus surgery or anterior cruciate ligament reconstruction and healthy controls.",
            "journal": "Journal of Sport Rehabilitation. In Press; 2026."
        },
        {
            "authors": "Lee J, Lee K, Lee YS, Park SK, Park J.",
            "title": "Lower extremity muscle activation patterns during running in individuals with and without anterior cruciate ligament reconstruction.",
            "journal": "Clinical Biomechanics. 137:106878. 2026."
        },
        {
            "authors": "Kim S, Park J.",
            "title": "Sex-specific associations of body mass index with quadriceps neuromuscular function and self-reported function in individuals with and without patellofemoral pain.",
            "journal": "Obesity Research & Clinical Practice. 19:518. 2025."
        },
        {
            "authors": "Seo D, Park J.",
            "title": "Ultrasonography assessment of talar cartilage and ATFL after running in chronically unstable, coper, and healthy ankles: A case-control study.",
            "journal": "Physiotherapy Theory and Practice. 41:1228. 2025."
        },
        {
            "authors": "Norte GE, Sherman DA, Ingersoll CD, Bodkin SG, Snyder-Mackler L, Grindstaff TL, Burland JP, Hopkins JT, Blackburn T, Chatput M, Konish Y, Rice D, Hart JH, Harkey MS, Zarzycki R, Palmieri-Smith RM, Lepely LK, Lepley AS, Pamukoff DN, Park J, Lisee C, Pietrosimone B, Thomas AC, Goetschius J, Touville TW, Kidgell DJ, and Kuenze C.",
            "title": "Advancing clinical evaluation and treatment of arthrogenic muscle inhibition: A need for validation and innovation-Letter to the Editor.",
            "journal": "American Journal of Sports Medicine. 52:NP34. 2024."
        },
        {
            "authors": "Kim S, Park J, Boling M, Glaviano N.",
            "title": "Lower extremity muscle volume in unilateral and bilateral patellofemoral pain: A cross-sectional exploratory study including superficial and deep muscles.",
            "journal": "Journal of Athletic Training. 59:915. 2024."
        },
        {
            "authors": "Kim S, Glaviano N, Park J.",
            "title": "Sex differences in knee extensor neuromuscular function in individuals with and without patellofemoral pain.",
            "journal": "Sports Health. 16:1000. 2024."
        },
        {
            "authors": "Lee J, Doo H, Roh Y, Song S, Oh M, Park J.",
            "title": "Change in pain perception and TENS pulse amplitude, and progression in aerobic and resistance exercises over a series of ten-session rehabilitation for anterior knee pain.",
            "journal": "Asian Journal of Kinesiology. 25:50. 2023."
        },
        {
            "authors": "Kim S, Park J.",
            "title": "Impact of severity and duration of anterior knee pain on quadriceps function and self-reported function.",
            "journal": "Journal of Athletic Training. 57:771. 2022."
        },
        {
            "authors": "Kim S, Park J.",
            "title": "Patients with chronic unilateral anterior knee pain experience bilateral deficits in quadriceps function and lower quarter flexibility: A cross-sectional study.",
            "journal": "Physiotherapy Theory and Practice. 38:2531. 2022."
        },
        {
            "authors": "Kim S, Park J.",
            "title": "Chronic unilateral knee pain experience bilateral deficits in quadriceps function and lower quarter flexibility.",
            "journal": "Physiotherapy Theory Practice. 28:2531. 2021."
        },
        {
            "authors": "Seeley MK, Denning WM, Park J, Croft K, Hopkins JT.",
            "title": "Anterior knee pain independently alters landing and jumping biomechanics.",
            "journal": "Clinical Biomechanics. 105458. 2021."
        },
        {
            "authors": "Roh Y, Park J.",
            "title": "Training and detraining effects of a rehabilitation programme with or without electro-cryotherapy in patients with anterior knee pain.",
            "journal": "Applied Sciences. 11:4812. 2021."
        },
        {
            "authors": "Park J, Kim J, Ko B.",
            "title": "Bilateral patella cartilage debridement and exercise rehabilitation for chondromalacia and plica syndrome: A case report.",
            "journal": "Applied Sciences. 11:4078. 2021."
        },
        {
            "authors": "Lee SY, Park J.",
            "title": "Emotional changes and functional progressions during postoperative rehabilitation in collegiate student-athletes: A preliminary study.",
            "journal": "Healthcare. 92:184. 2021."
        },
        {
            "authors": "Kim S, Kim D, Park J.",
            "title": "Knee joint and quadriceps dysfunction in individuals with anterior knee pain, anterior cruciate ligament reconstruction, and meniscus surgery: A cross-sectional study.",
            "journal": "Journal of Sport Rehabilitation. 30:112. 2021."
        },
        {
            "authors": "Kim S, Kim D, Park J.",
        ...
        {
            "authors": "Park J, Denning WM, Pitt J, Hopkins JT, Seeley MK.",
            "title": "Experimental knee pain affects lower-extremity muscle activation during landing and jumping.",
            "journal": "Journal of Sport Rehabilitation. 26:78. 2017."
        },
        {
            "authors": "Park J, Cosby N.",
            "title": "Arthroscopic repair versus non-operative treatment of first-time traumatic anterior shoulder dislocations: A numbers-needed-to-treat analysis.",
            "journal": "Clinics in Shoulder and Elbow. 19:110. 2016."
        },
        {
            "authors": "Park J, Grindstaff TL.",
            "title": "Overuse capsuloligamentous injury of the first metatarsophalangeal joint: a case report.",
            "journal": "Journal of Korean Foot & Ankle Society. 19:128. 2015."
        },
        {
        ...
        {
            "authors": "Seeley MK, Park J, Hopkins JT.",
            "title": "Experimental knee pain alters lower-extremity mechanics during walking and running.",
            "journal": "Journal of Athletic Training. 23:19. 2013."
        },
        {
            "authors": "Park J, Hopkins JT.",
            "title": "Induced knee pain immediately reduces involuntary and voluntary quadriceps activation.",
            "journal": "Clinical Journal of Sport Medicine. 23:19. 2013."
        },
        {
            "authors": "Park J, Hopkins JT.",
            "title": "Within and between reliability of the maximal voluntary knee extension torque and activation.",
            "journal": "International Journal of Neuroscience. 123:55. 2013."
        },
        {
            "authors": "Park J, Hopkins JT.",
            "title": "Immediate effects of acupuncture and cryotherapy on quadriceps motoneuron pool excitability: Randomised trial using anterior knee infusion model.",
            "journal": "Acupuncture in Medicine. 30:195. 2012."
        },
        {
            "authors": "Park J, Grindstaff TL, Hart JM, Hertel J, Ingersoll CD.",
            "title": "Knee extension exercises do not immediately increase quadriceps activation individuals with anterior knee pain.",
            "journal": "Journal of Sport Rehabilitation. 21:119. 2012."
        },
        {
            "authors": "Park J, Nasypany A.",
            "title": "Psychological consultation in rehabilitation.",
            "journal": "Internet Journal of Allied Health Sciences and Practice. 10:2012."
        },
        {
            "authors": "Park J, Hopkins JT.",
            "title": "Quadriceps activation normative values and the affect of subcutaneous tissue thickness.",
            "journal": "Journal of Electromyography and Kinesiology. 21:136. 2011."
        }
    ],
    "2": [
        {
            "authors": "Park S, Lim J, Lee J, Jeon S, Kim J, Park J.",
            "title": "Acute recovery in the femoral cartilage morphology following running and cool-down protocols.",
            "journal": "PeerJ. 12:e18302. 2024."
        },
        {
            "authors": "Lim J, Lee J, Park S, Lee J, Park J.",
            "title": "Change in femoral cartilage cross-sectional area after aerobic and resistance exercise.",
            "journal": "International Journal of Sports Medicine. 45:705. 2024."
        },
        {
            "authors": "Lee J, Lim J, Park S, Kim S, Park J.",
            "title": "Morphologic response in femoral cartilage during and after 40-min treadmill running.",
            "journal": "Journal of Athletic Training. 59:906. 2024."
        },
        {
            "authors": "Kim S, Glaviano N, Park J.",
        ...
        {
            "authors": "Kim S, Roh Y, Glaviano N, Park J.",
            "title": "Quadriceps Neuromuscular Function during and after Exercise-induced Fatigue in Patients with Patellofemoral Pain.",
            "journal": "Journal of Athletic Training. 58:554. 2023."
        },
        {
            "authors": "Nam A, Park J.",
            "title": "Bilateral knee joint cooling on anaerobic capacity and wheel cadence during sprint cycling intervals.",
            "journal": "Healthcare. 10:1951. 2022."
        },
        {
        ...
        {
            "authors": "Lim J, Park J, Lee S, Park J.",
            "title": "Comparison of four different cool-down strategies on lower-leg temperature, blood lactate concentration, and fatigue perception after intense running.",
            "journal": "Journal of Sport Rehabilitation. 31:1052. 2022."
        },
        {
            "authors": "Lim J, Park H, Lee S, Park J.",
            ...
            "journal": "Exercise Science. 31:72. 2022."
        },
        {
        ...
        {
            "authors": "Kim H, Lee D, Choi HM, Park J.",
            "title": "Joint cooling does not hinder athletic performance during high-intensity intermittent exercise.",
            "journal": "International Journal of Sports Medicine. 7:641. 2016."
        },
        {
            "authors": "Park J.",
            "title": "Cold application and functional performance.",
            "journal": "Asian Journal of Kinesiology. 17:29. 2015."
        }
    ],
    "3": [
        {
        ...
        {
            "authors": "Jeon S, Seo D, Lee S, Kim H, Park J.",
            "title": "Simple linear equations to estimate a workload of specific repetition maximum for squat exercise in trained and untrained males.",
            "journal": "Exercise Science. 34:497. 2025."
        },
        {
            "authors": "Lee S, Lim J, Park J.",
            "title": "A warm-up strategy with or without voluntary contraction on athletic performance, lower-leg temperature, and blood lactate concentration.",
            "journal": "Plos ONE. 19:e0295537. 2024."
        },
        {
        ...
        },
        {
            ...
            "title": "Central vs.",
            "journal": "peripheral vision during a single-leg drop jump. Applied Sciences. 12:2599. 2022."
        },
        {
            "authors": "Park J, Song KT, Lee SY.",
            "title": "A single-leg drop jump biomechanics after ankle or knee joint cooling in healthy young adults.",
            "journal": "Journal of Sport Rehabilitation. 31:271. 2021."
        },
        {
            "authors": "Lee H, Shin J, Kim D, Park J.",
            "title": "Effect or verbal encouragement on quadriceps and knee joint function during three sets of knee extension exercise.",
            "journal": "Isokinetics and Exercise Science. 29:155. 2021."
        },
        {
            "authors": "Min KE, Lee YS, Park J.",
            "title": "Changes in spinal-reflex excitability during static stretch and/or explosive contraction.",
            "journal": "Applied Sciences. 11:2830. 2021."
        },
        {
            "authors": "Park J, Song KT, Lee SY, Ryu H.",
            "title": "Knee joint cooling altered the quadriceps neuromuscular activation during a single-leg drop jump.",
            "journal": "Exercise Science. 29:225. 2020."
        },
        {
            "authors": "Lee YS, Min KE, Park J.",
            "title": "Correlation and reliability of two field tests for vertical jump height.",
            "journal": "Asian Journal of Kinesiology. 22:9. 2020."
        },
        {
            "authors": "Jang HS, Kim D, Park J.",
            "title": "Immediate effects of different types of stretching exercises on badminton smash.",
            "journal": "Journal of Sports Medicine and Physical Fitness. 58:1014. 2018."
        },
        {
            "authors": "Park J, Seeley MK, Francom D, Reese CS, Hopkins JT.",
            "title": "Functional vs.",
            "journal": "traditional analysis in biomechanical gait data: an alternative statistical approach. Journal of Human Kinetics. 60:39. 2017."
        },
        {
            "authors": "Han S, Lee H, Kim H, Choi C, Kim D, Park J.",
            "title": "A 6-week sprint interval training program changes anaerobic capacity, quadriceps strength, and subcutaneous tissue thickness.",
            "journal": "International Journal of Sports Medicine. 38:105. 2017."
        },
        {
            "authors": "Lee M, Kim S, Choi HM, Park J.",
            "title": "Ankle or knee joint cooling alters countermovement jump height in healthy collegiate athletes.",
            "journal": "Isokinetics and Exercise Science. 25:1. 2017."
        }
    ],
    "4": [
        {
            "authors": "Lee S, Kim S, Lim J, Park J.",
            "title": "Femoral Cartilage Morphology in Collegiate Archery, Badminton, and Taekwondo Athletes and Non-athletes: A 12-month Prospective Cohort Study.",
            "journal": "Sports Health. In Press: 2026."
        },
        {
            "authors": "Lee J, Lim J, Kim S, Song I, Lim S, Yoon J, Park J.",
            "title": "Injury incidences related to acute-to-chronic workload ratios in taekwondo: A prospective study with a 3-year follow-up.",
            "journal": "Journal of Athletic Training. 60:569. 2025."
        },
        {
            "authors": "Moon J, Kim GT, Park J.",
            "title": "Sponge mats, but not Taekwondo mats, reduce landing impact from heights of 0.45m, 0.90m, and 1.35m in Taekwondo Gyeokpa players.",
            "journal": "Journal of Sport Rehabilitation. 34:505. 2025."
        },
        {
            "authors": "Doo H, Kim D, Kim C, Lee SY, Park J.",
            "title": "Comparisons of musculoskeletal injuries among three different modalities of Taekwondo (Kyorugi, Poomsae, and Shibum): A one-year follow-up prospective epidemiologic study.",
            "journal": "Research in Sports Medicine. 31:528. 2023."
        },
        {
            "authors": "Jang YH, Jang HS, Park S, Yun HH, Kim D, Park J.",
            "title": "Epidemiology of injuries in collegiate men’s badminton: A five-year prospective study.",
            "journal": "Medicina dello Sport. 75:96. 2022."
        },
        {
            "authors": "Park J, Kim D, Lee W, Han S, Yoon HJ, Jang HS, Ahn CJ.",
            "title": "Epidemiology of Korean collegiate injuries for six sports.",
            "journal": "Korean Journal of Sport Science. 27:382. 2016."
        }
    ]
};

        for (let i = 1; i <= 4; i++) {
            const list = document.getElementById('paper-list-' + i);
            if (!list) continue;
            ...
            papersData[i].forEach(paper => {
                ...
                let html = '';
                if(paper.authors) {
                    html += '<div style="font-weight:700; color:#444; font-size:0.95rem; margin-bottom:6px;">' + paper.authors + '</div>';
                }
                html += '<div style="font-weight:600; color:var(--color-primary); font-size:1.1rem; margin-bottom:6px; line-height:1.4;">' + paper.title + '</div>';
                if(paper.journal) {
                    html += '<div style="color:#666; font-size:0.9rem; font-style:italic;">' + paper.journal + '</div>';
                }
...
// ==========================================
const sportsData = {
    "축구": { icon: '<img src="assets/icons/축구.svg" class="custom-svg-icon">', head: "강석", sub: ["조현준", "김예종", "오승진", "이복음"] },
    "야구": { icon: '<img src="assets/icons/야구.svg" class="custom-svg-icon">', head: "유주승", sub: ["송서옥", "채상우", "박서현", "홍진후"] },
    "농구": { icon: '<img src="assets/icons/농구.svg" class="custom-svg-icon">', head: "이상준", sub: ["이진호", "정연우", "김민주", "김성준", "김동언", "황이삭"] },
    "배구": { icon: '<img src="assets/icons/배구.svg" class="custom-svg-icon">', head: "박세민", sub: ["문민서", "장서현", "이다현", "황성윤", "박인서", "박유빈"] },
    "럭비": { icon: '<img src="assets/icons/럭비.svg" class="custom-svg-icon">', head: "유영민", sub: ["이도형", "최성찬"] },
    "골프": { icon: '<img src="assets/icons/골프.svg" class="custom-svg-icon">', head: "이예인", sub: ["문수연", "유승원", "최주영", "김무건"] },
    "배드민턴": { icon: '<img src="assets/icons/배드민턴.svg" class="custom-svg-icon">', head: "권남준", sub: [] },
    "핸드볼": { icon: '<img src="assets/icons/핸드볼.svg" class="custom-svg-icon">', head: "기윤서", sub: ["정준영", "남가민", "박다은", "김민지"] },
    "시범단": { icon: '<img src="assets/icons/시범단.svg" class="custom-svg-icon">', head: "문채연", sub: ["우민서", "김한결", "김다은", "권인혜", "김다감", "남수현"] },
    "겨루기": { icon: '<img src="assets/icons/겨루기.svg" class="custom-svg-icon">', head: ["유지민", "한혜서"], sub: ["정도엽", "조연지", "박은지"] },
    "품새": { icon: '<img src="assets/icons/품새.svg" class="custom-svg-icon">', head: "유승아", sub: ["홍혜원", "권준휘", "이은채", "김형우"] },
    "센터": { icon: '<img src="assets/icons/센터.svg" class="custom-svg-icon">', head: "담당자 미정", sub: ["권준홍", "천지훈", "안은지", "이천이"] }
};
